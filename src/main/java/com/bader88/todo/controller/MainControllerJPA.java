...
public class MainControllerJPA {
    ...
    public String getToDOList(ModelMap modelMap){
        ...
        List<TodoEntity> ToDos = toDoRepo.findByUsername(username);
...
//        toDoService.addToDo(username,todoEntity.getDescription(), todoEntity.getTargetDate(),todoEntity.getIsDone());
